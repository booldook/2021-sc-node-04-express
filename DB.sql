...
CREATE TABLE IF NOT EXISTS `uploadfiles` (
  ...
  `size` int NOT NULL,
  `mimeType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- 테이블 booldook.user 구조 내보내기
CREATE TABLE IF NOT EXISTS `user` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `userid` varchar(24) NOT NULL,
  `userpw` char(72) NOT NULL DEFAULT '',
  `username` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `grade` tinyint unsigned NOT NULL DEFAULT '3',
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
